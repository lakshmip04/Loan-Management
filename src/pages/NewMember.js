...
function NewMember() {
  ...
  // Generate preview customer ID for display
  const previewCusId = `CUS${Date.now()}`;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Send data to the API (cusid will be generated by the server)
      const response = await members.create(formData);

      if (response.data.success) {
        // Show success message
        alert(`Member registered successfully! Customer ID: ${response.data.data.cusid}`);
      ...
      <form onSubmit={handleSubmit} className="bg-white shadow-lg rounded-xl p-8 space-y-8">
        ...
        <div className="border-b border-gray-200 pb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              <label className="block text-base font-medium text-gray-700 mb-2">Customer ID</label>
              <input
                type="text"
              ...
              />
              <p className="text-xs text-gray-500 mt-1">Customer ID will be automatically generated when you submit the form</p>
            </div>
            <div>
