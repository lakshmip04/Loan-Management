          ...
          <div className={`absolute left-full top-0 ml-2 w-64 bg-white shadow-lg rounded-lg py-2 ${isLoansMenuOpen ? 'block' : 'hidden'} z-10`}>
            ...
            <div className="relative">
              ...
              <div className={`absolute left-full top-0 ml-2 w-64 bg-white shadow-lg rounded-lg py-2 ${isBusinessSubMenuOpen ? 'block' : 'hidden'} z-20`}>
                <NavLink to="/business-loan/scheme1" className="block px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600">Scheme 1</NavLink>
                <NavLink to="/business-loan/scheme2" className="block px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600">Scheme 2</NavLink>
                <NavLink to="/business-loan/scheme3" className="block px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600">Scheme 3</NavLink>
                <NavLink to="/business-loan/scheme4" className="block px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600">Scheme 4</NavLink>
                <NavLink to="/business-loan/scheme5" className="block px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600">Scheme 5</NavLink>
              </div>
            </div>
            <NavLink to="/gold" className="block px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600">Gold Loan</NavLink>
            <div className="relative">
              <button 
              ...
              <div className={`absolute left-full top-0 ml-2 w-64 bg-white shadow-lg rounded-lg py-2 ${isLendboxSubMenuOpen ? 'block' : 'hidden'} z-20`}>
                <NavLink to="/lendbox/personal" className="block px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600">Personal</NavLink>
                <NavLink to="/lendbox/scheme1" className="block px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600">Scheme 1 - Weekly</NavLink>
                <NavLink to="/lendbox/scheme2" className="block px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600">Scheme 2</NavLink>
              </div>
            </div>
          </div>
        </div>
